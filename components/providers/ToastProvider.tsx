  ...
  return (
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          toast:
            "!p-3 bg-background text-foreground border-border border-2 font-heading rounded-base text-[13px] flex items-center gap-2.5 w-[356px] [&:has(button)]:justify-between",
